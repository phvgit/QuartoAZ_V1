...
def print_main_menu():
    ...
    print_header()
    print(f"{Colors.GREEN}  JOUER{Colors.RESET}")
    ...
    print()
    print(f"{Colors.BLUE}  ENTRAINEMENT{Colors.RESET}")
...
def print_training_menu():
    ...
    clear_screen()
    print_header()
    print(f"{Colors.BLUE}{Colors.BOLD}  ENTRAINEMENT DE L'IA{Colors.RESET}")
    print()
    print(f"  {Colors.GREEN}Presets:{Colors.RESET}")
    ...
    print()
    print(f"  {Colors.YELLOW}Personnalise:{Colors.RESET}")
